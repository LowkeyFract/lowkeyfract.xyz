...
const musicTracks = [
    {
        name: "Under Your Spell - Slowed",
        file: "audio/Snow_Strippers_Under_your_spell_Slowed_Reverb.mp3",
        ...
        <div class="music-player">
            ...
            <div class="music-content">
                ...
                <div class="music-track-info">
                    ...
                    <div class="music-artist">${musicTracks[0].author}</div>
                </div>
            </div>
...
async function getserverinfo(forceRefresh = false) {
    ...
    try {
        const response = await fetch('https://discord.com/api/v8/invites/vXsfzGmv8f?with_counts=true');
        if (response.ok) {
...
function createserverinvitecard(serverData) {
    ...
    return `
        <div class="invite-card server-invite" onclick="window.open('https://discord.gg/vXsfzGmv8f', '_blank')">
...
function showOfflineState() {
    ...
    const acts = document.getElementById('activities');
    username.textContent = 'lowkeyfract';
